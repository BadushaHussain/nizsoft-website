        ...
        <AnimatePresence>
            {visible && (
                <motion.div
                    ...
                    className="fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-dark-light/80 backdrop-blur-xl border-t border-gray-200 dark:border-white/10 p-3 md:p-4 z-40 shadow-2xl"
                >
