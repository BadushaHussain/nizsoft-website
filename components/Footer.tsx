...
export default function Footer() {
  return (
    <footer className="bg-dark-light border-t border-white/5 mt-24">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-20 pb-32">
        ...
        <div className="pt-12 border-t border-white/5 text-center text-gray text-xs">
          <p>&copy; 2025 NIZSOFT Technology LLC. All rights reserved. | <Link href="/privacy" className="hover:text-white">Privacy</Link> | <Link href="/terms" className="hover:text-white">Terms</Link> | <Link href="#" className="hover:text-white">Security</Link> | <Link href="#" className="hover:text-white">SLA</Link></p>
        </div>
      </div>
    </footer>
  )
