...
import { HiArrowLeft, HiMapPin, HiClock, HiPresentationChartLine } from 'react-icons/hi2'
import { getProductDesignJobs } from '@/data/jobs'

export const metadata = {
    title: 'Product & Design Positions | NIZSOFT Careers',
    description: 'Join our product and design team shaping the future of insurance user experiences. Open positions in product management, UX/UI design, and research.',
}

export default function ProductDesignJobsPage() {
    const jobs = getProductDesignJobs()

    return (
        <div className="animate-fade-in">
            {/* Hero Section */}
            <section className="min-h-[40vh] flex items-center justify-center relative overflow-hidden pt-4 md:pt-6 bg-gradient-to-br from-primary/5 to-transparent">
                <div className="max-w-6xl px-6 lg:px-8 text-center relative z-10 py-16">
                    <Link href="/company/careers" className="inline-flex items-center gap-2 text-primary hover:underline mb-4">
                        <HiArrowLeft /> Back to Careers
                    </Link>

                    <div className="inline-flex items-center gap-3 mb-6">
                        <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center">
                            <HiPresentationChartLine className="w-8 h-8 text-primary" />
                        </div>
                    ...
                    <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-4 max-w-3xl mx-auto">
                        Shape user experiences and product strategy for the insurance industry
                    </p>
            ...
            <section className="max-w-[1400px] mx-auto px-6 lg:px-12 py-20">
                <div className="bg-gradient-to-r from-primary to-primary/80 rounded-2xl p-12 text-center text-white">
                    ...
                    <p className="text-xl mb-4 text-white/90 max-w-2xl mx-auto">
                        Join our product and design team to create exceptional user experiences.
                    </p>
